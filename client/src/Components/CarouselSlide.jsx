  ...
  return (
    <div className="md:w-auto w-full flex md:flex-row flex-col gap-7 mx-auto md:h-[350px] h-[550px] overflow-hidden">
      ...
      <div className="flex flex-col md:gap-10 gap-6">
        <h2 className="md:text-5xl font-inter text-3xl w-fit text-[#9b172a]-800 dark:text-violet-400 font-semibold md:self-auto self-center relative after:content-[' '] after:w-[60%] after:h-1 rounded-full after:bg-[#9b172a] dark:after:bg-white after:absolute after:-bottom-3 after:left-0">
          {details.title}
        </h2>
        ...
        <p className="flex flex-col gap-0">
          <BsQuote
            size={60}
            className=" text-[#9b172a] dark:text-red-400 font-semibold"
          />
          ...
          <BsQuote
            size={50}
            className=" text-[#9b172a] dark:text-red font-semibold self-end rotate-180"
          />
        </p>
      </div>
    </div>

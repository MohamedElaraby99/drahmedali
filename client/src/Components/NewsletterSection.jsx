...
const NewsletterSection = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-r from-[#9b172a] via-[#9b172a] to-[#9b172a]-800">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="relative">
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl text-[#9b172a]-100 mb-8 max-w-2xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="max-w-md mx-auto">
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <button
                  type="submit"
                  className="group px-8 py-4 bg-white text-[#9b172a] font-semibold rounded-full hover:bg-[#9b172a]-50 transition-all duration-300 transform hover:scale-105 shadow-lg"
                >
            ...
            <p className="text-[#9b172a]-200 text-sm mt-6">

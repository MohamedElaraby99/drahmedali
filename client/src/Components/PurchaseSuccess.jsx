        ...
        <div className="space-y-4">
          ...
          <div className="bg-green-50 dark:bg-green-900/20 rounded-xl p-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-gradient-to-r from-[#9b172a] to-[#9b172a] rounded-lg flex items-center justify-center">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-1">
                  <FaCoins className="text-[#9b172a] text-xs" />
          ...
          <div className="flex gap-2">
            <button
              onClick={onClose}
              className="flex-1 bg-gradient-to-r from-[#9b172a] to-[#9b172a] text-white py-3 px-4 rounded-xl font-semibold hover:from-[#9b172a] hover:to-[#9b172a]-700 transition-all duration-200 transform hover:scale-[1.02] flex items-center justify-center gap-2"
            >

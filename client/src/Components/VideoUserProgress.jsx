...
const VideoUserProgress = ({ videoId, courseId }) => {
  ...
  const getProgressColor = (progress) => {
    ...
    if (progress >= 70) return 'text-[#9b172a]';
    if (progress >= 50) return 'text-[#9b172a]';
    return 'text-red-500';
  };
  ...
  const getStatusIcon = (progress, isCompleted, totalWatchTime) => {
    ...
    if (progress > 0) {
      return <FaPlay className="text-[#9b172a]" />;
    }
    ...
    return (
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-3 sm:p-4 mb-4">
        <div className="flex items-center justify-center py-4">
          <div className="animate-spin rounded-full h-6 w-6 sm:h-8 sm:w-8 border-b-2 border-[#9b172a]"></div>
    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-3 sm:p-4 mb-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
        <div className="flex items-center gap-3">
          <FaUsers className="text-[#9b172a] text-lg sm:text-xl flex-shrink-0" />
                  ...
                  <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                    <div 
                      className={`h-2 rounded-full transition-all duration-300 ${
                        userProgress.isCompleted ? 'bg-green-500' : 'bg-[#9b172a]'
                      }`}
      ...
      <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 text-xs sm:text-sm">
          <div className="text-center bg-[#9b172a]-50 dark:bg-[#9b172a]-900/20 rounded-lg p-3">
            <div className="text-lg sm:text-2xl font-bold text-[#9b172a]">{sortedUsers.length}</div>
          ...
          <div className="text-center bg-[#9b172a]-50 dark:bg-[#9b172a]-900/20 rounded-lg p-3">
            <div className="text-lg sm:text-2xl font-bold text-[#9b172a]">

        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-[#9b172a] focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                />
              </div>
          ...
          <div className={`grid gap-4 mb-8 ${isAdmin ? 'grid-cols-1 md:grid-cols-4' : 'grid-cols-1 md:grid-cols-3'}`}>
            <div className="bg-[#9b172a]-50 dark:bg-[#9b172a]-900/20 p-4 rounded-lg">
              <div className="text-2xl font-bold text-[#9b172a] dark:text-[#9b172a]-400">{total}</div>
              <div className="text-sm text-[#9b172a] dark:text-[#9b172a]-400">إجمالي الأسئلة والأجوبة</div>
            </div>
            ...
            {isAdmin && (
              <div className="bg-[#9b172a]-50 dark:bg-[#9b172a]-900/20 p-4 rounded-lg">
                ...
                <div className="text-sm text-[#9b172a] dark:text-[#9b172a]-400">في الانتظار</div>
              </div>
            )}
            <div className="bg-[#9b172a]-50 dark:bg-[#9b172a]-900/20 p-4 rounded-lg">
              <div className="text-2xl font-bold text-[#9b172a] dark:text-[#9b172a]-400">
              ...
              <div className="text-sm text-[#9b172a] dark:text-[#9b172a]-400">مميز</div>
            </div>
          </div>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <h3 className="text-xl font-semibold text-gray-800 dark:text-white mb-3">
                        <Link to={`/qa/${qa._id}`} className="hover:text-[#9b172a] dark:hover:text-[#9b172a]-400 transition-colors">
                          {qa.question}
                        </Link>
                      </h3>
                      ...
                      {qa.answer ? (
                        ...
                        <div className="mb-4 p-3 bg-[#9b172a]-50 dark:bg-[#9b172a]-900/20 border border-[#9b172a]-200 dark:border-[#9b172a]-800 rounded-lg">
                          <div className="flex items-center gap-2 text-[#9b172a]-800 dark:text-[#9b172a]-200">
                            <FaClock className="text-sm" />
                            <span className="text-sm font-medium">في انتظار الإجابة</span>
                          </div>
                          <p className="text-[#9b172a]-700 dark:text-[#9b172a]-300 text-sm mt-1">
                          ...
                          {isAdmin && (
                            <div className="flex items-center gap-2">
                              <button
                                ...
                                className="flex items-center gap-1 px-3 py-1 bg-[#9b172a] hover:bg-[#9b172a]-700 text-white rounded-lg text-sm transition-colors"

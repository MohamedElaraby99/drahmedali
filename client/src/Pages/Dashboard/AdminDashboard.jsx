...
export default function AdminDashboard() {
  ...
  return (
    <Layout>
      <div className="min-h-screen bg-gradient-to-br from-[#9b172a]-50 via-indigo-50 to-[#9b172a]-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900" dir="rtl">
        {/* Hero Section */}
        <section className="relative py-16 px-4 overflow-hidden">
          ...
          {/* Floating Elements */}
          <div className="absolute top-20 left-10 w-20 h-20 bg-[#9b172a]-200 dark:bg-[#9b172a]-800 rounded-full opacity-20 animate-bounce"></div>
          <div className="absolute top-40 right-20 w-16 h-16 bg-[#9b172a]-200 dark:bg-[#9b172a]-800 rounded-full opacity-20 animate-pulse"></div>
          ...
          <div className="relative z-10 container mx-auto">
            ...
            <div className={`text-center mb-12 transition-all duration-1000 ease-out ${
              ...
              <h1 className={`text-4xl md:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#9b172a] via-[#9b172a] to-indigo-600 dark:from-[#9b172a]-400 dark:via-[#9b172a]-400 dark:to-indigo-400 mb-4 transition-all duration-700 delay-200 ${
                heroLoaded 
              ...
              style={{ transitionDelay: '800ms' }}>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-4 lg:p-6">
                  <div className="flex items-center gap-3 mb-4 lg:mb-6">
                    <div className="p-2 bg-[#9b172a]-100 dark:bg-[#9b172a]-900/30 rounded-lg">
                      <FaChartLine className="text-[#9b172a] dark:text-[#9b172a]-400 text-lg lg:text-xl" />
                    </div>
                      ...
                      <div className="absolute inset-0 flex items-center justify-center bg-white dark:bg-gray-800 bg-opacity-80 dark:bg-opacity-80 rounded-lg">
                        <div className="text-center">
                          ...
                          <button 
                            ...
                            className="px-4 py-2 bg-[#9b172a] hover:bg-[#9b172a] text-white rounded-lg text-sm transition-colors"
                          >
                            إعادة التحميل
                          </button>
                        </div>
            ...
            style={{ transitionDelay: '900ms' }}>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 lg:gap-4">
                ...
                <button
                  ...
                  className="group p-3 lg:p-4 bg-gradient-to-r from-[#9b172a] to-[#9b172a] rounded-lg lg:rounded-xl text-white hover:from-[#9b172a] hover:to-[#9b172a]-700 transition-all duration-200 transform hover:scale-105"
                >
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl lg:rounded-2xl shadow-lg lg:shadow-xl p-4 lg:p-6 mb-8 lg:mb-12">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
                ...
                {/* إدارة الأجهزة */}
                <div className="bg-gradient-to-br from-[#9b172a] to-[#9b172a] rounded-xl p-4 lg:p-6 text-white hover:from-[#9b172a] hover:to-[#9b172a]-700 transition-all duration-200 transform hover:scale-105 cursor-pointer shadow-lg hover:shadow-xl" onClick={() => navigate("/admin/device-management")}>
                  <div className="flex items-center justify-between mb-3">
                    <FaServer className="text-2xl lg:text-3xl text-[#9b172a]-200" />
                    <div className="w-3 h-3 bg-[#9b172a]-200 rounded-full animate-pulse"></div>
                  </div>
                  <h4 className="text-lg lg:text-xl font-bold mb-2">إدارة الأجهزة</h4>
                  <p className="text-[#9b172a]-100 text-sm lg:text-base opacity-90">مراقبة وإدارة الأجهزة المتصلة</p>
                  <div className="mt-4 flex items-center justify-between">
                    <span className="text-xs text-[#9b172a]-200">إدارة كاملة</span>
                    <FaArrowUp className="text-[#9b172a]-200 transform rotate-45" />
                  </div>
                </div>
                ...
                {/* إدارة المراحل */}
                <div className="bg-gradient-to-br from-[#9b172a] to-[#9b172a] rounded-xl p-4 lg:p-6 text-white hover:from-[#9b172a] hover:to-[#9b172a]-700 transition-all duration-200 transform hover:scale-105 cursor-pointer shadow-lg hover:shadow-xl" onClick={() => navigate("/admin/stages")}>
                  <div className="flex items-center justify-between mb-3">
                    <FaGraduationCap className="text-2xl lg:text-3xl text-[#9b172a]-200" />
                    <div className="w-3 h-3 bg-[#9b172a]-200 rounded-full animate-pulse"></div>
                  </div>
                  <h4 className="text-lg lg:text-xl font-bold mb-2">إدارة المراحل</h4>
                  <p className="text-[#9b172a]-100 text-sm lg:text-base opacity-90">إدارة المراحل الدراسية</p>
                  <div className="mt-4 flex items-center justify-between">
                    <span className="text-xs text-[#9b172a]-200">إدارة كاملة</span>
                    <FaArrowUp className="text-[#9b172a]-200 transform rotate-45" />
                  </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl lg:rounded-2xl shadow-lg lg:shadow-xl p-4 lg:p-6 mb-8 lg:mb-12">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
                ...
                <div className="bg-gradient-to-br from-[#9b172a] to-[#9b172a] rounded-xl p-4 lg:p-6 text-white hover:from-[#9b172a] hover:to-[#9b172a]-700 transition-all duration-200 transform hover:scale-105 cursor-pointer shadow-lg hover:shadow-xl" onClick={() => navigate("/admin/course-access-codes")}>
                  <div className="flex items-center justify-between mb-3">
                    <FaTicketAlt className="text-2xl lg:text-3xl text-[#9b172a]-200" />
                    <div className="w-3 h-3 bg-[#9b172a]-200 rounded-full animate-pulse"></div>
                  </div>
                  <h4 className="text-lg lg:text-xl font-bold mb-2">أكواد فتح الكورس</h4>
                  <p className="text-[#9b172a]-100 text-sm lg:text-base opacity-90">توليد أكواد وصول مؤقتة لكورس محدد</p>
                  <div className="mt-4 flex items-center justify-between">
                    <span className="text-xs text-[#9b172a]-200">توليد وإدارة</span>
                    <FaArrowUp className="text-[#9b172a]-200 transform rotate-45" />
                  </div>
                </div>
                ...
                {/* الجلسات المباشرة */}
                <div className="bg-gradient-to-br from-[#9b172a] to-[#9b172a] rounded-xl p-4 lg:p-6 text-white hover:from-[#9b172a] hover:to-[#9b172a]-700 transition-all duration-200 transform hover:scale-105 cursor-pointer shadow-lg hover:shadow-xl" onClick={() => navigate("/admin/live-meetings")}>
                  <div className="flex items-center justify-between mb-3">
                    <FaVideo className="text-2xl lg:text-3xl text-[#9b172a]-200" />
                    <div className="w-3 h-3 bg-[#9b172a]-200 rounded-full animate-pulse"></div>
                  </div>
                  <h4 className="text-lg lg:text-xl font-bold mb-2">الجلسات المباشرة</h4>
                  <p className="text-[#9b172a]-100 text-sm lg:text-base opacity-90">إدارة الجلسات المباشرة</p>
                  <div className="mt-4 flex items-center justify-between">
                    <span className="text-xs text-[#9b172a]-200">إدارة كاملة</span>
                    <FaArrowUp className="text-[#9b172a]-200 transform rotate-45" />
                  </div>

                  ...
                  <div className="p-6 border-b border-gray-200 dark:border-gray-700">
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className="bg-[#9b172a] hover:bg-[#9b172a]-700 text-white px-4 py-2 rounded-lg font-medium transition-colors flex items-center gap-2"
                      >
                        <FaEye />
                        عرض التفاصيل
                      </button>
                                ...
                                <td className="px-4 py-4 whitespace-nowrap">
                                  <div className="flex items-center">
                                    <div className="flex-shrink-0 h-8 w-8">
                                      <div className="h-8 w-8 rounded-full bg-[#9b172a]-100 dark:bg-[#9b172a]-900 flex items-center justify-center">
                                        <FaUser className="h-4 w-4 text-[#9b172a] dark:text-[#9b172a]-400" />
                                      </div>
                                    </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto m-4">
              <div className="p-6">
                ...
                {selectedExam.students.length > 0 && (
                  <div className="bg-[#9b172a]-50 dark:bg-[#9b172a]-900/20 rounded-lg p-4 mb-6">
                    <h4 className="font-semibold text-[#9b172a]-900 dark:text-[#9b172a]-100 mb-3">إحصائيات الامتحان</h4>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                      <div className="text-center">
                        <div className="text-2xl font-bold text-[#9b172a]">
                          {selectedExam.students.length}
                        </div>
                        <div className="text-[#9b172a]-700 dark:text-[#9b172a]-300">إجمالي الطلاب</div>
                      </div>
                      <div className="text-center">
                      ...
                      <div className="text-center">
                        ...
                        <div className="text-[#9b172a]-700 dark:text-[#9b172a]-300">متوسط النتيجة</div>
                      </div>
                    </div>
                  </div>
                )}

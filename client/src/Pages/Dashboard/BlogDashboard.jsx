        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
            ...
            <button
              ...
              className="bg-[#9b172a] hover:bg-[#9b172a]-700 text-white px-6 py-3 rounded-lg flex items-center gap-2 transition-colors duration-200"
            >
              <FaPlus />
                            إنشاء مدونة جديدة
            </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
              <div className="flex items-center justify-between">
                ...
                <div className="bg-[#9b172a]-100 dark:bg-[#9b172a]-900 p-3 rounded-full">
                  <FaEye className="text-[#9b172a] dark:text-[#9b172a]-400" />
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-[#9b172a]">{draftBlogs}</p>
                </div>
                <div className="bg-[#9b172a]-100 dark:bg-[#9b172a]-900 p-3 rounded-full">
                  <FaEdit className="text-[#9b172a] dark:text-[#9b172a]-400" />
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-[#9b172a]">{totalViews}</p>
                </div>
                <div className="bg-[#9b172a]-100 dark:bg-[#9b172a]-900 p-3 rounded-full">
                  <FaEye className="text-[#9b172a] dark:text-[#9b172a]-400" />
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#9b172a]"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#9b172a]"
                >
                  ...
                  {loading ? (
                    ...
                    blogs.map((blog) => (
                      <tr key={blog._id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                        ...
                        <td className="px-6 py-4">
                          <span className="px-2 py-1 text-xs font-medium bg-[#9b172a]-100 dark:bg-[#9b172a]-900 text-[#9b172a]-800 dark:text-[#9b172a]-200 rounded-full">
                            {blog.category}
                          </span>
                        </td>
                        <td className="px-6 py-4">
                          <span className={`px-2 py-1 text-xs font-medium rounded-full ${
                            blog.status === 'published' 
                              ...
                              : 'bg-[#9b172a]-100 dark:bg-[#9b172a]-900 text-[#9b172a]-800 dark:text-[#9b172a]-200'
                          }`}>
                            {blog.status}
                          </span>
                        </td>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-8 max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
              ...
              <form onSubmit={handleCreateBlog} className="space-y-4">
                ...
                <div className="flex justify-end gap-4 pt-4">
                  ...
                  <button
                    type="submit"
                    className="px-6 py-2 bg-[#9b172a] text-white rounded-lg hover:bg-[#9b172a]-700"
                  >
                    إنشاء المدونة
                  </button>
                </div>

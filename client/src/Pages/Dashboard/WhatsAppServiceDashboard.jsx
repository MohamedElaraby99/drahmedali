                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex justify-between items-center mb-8">
                        ...
                        <button
                            ...
                            className="bg-[#9b172a] hover:bg-[#9b172a]-700 text-white px-6 py-3 rounded-lg font-medium flex items-center gap-2 transition-colors"
                        >
                            <FaPlus />
                            إضافة خدمة جديدة
                        </button>
                    ...
                    {adminLoading ? (
                        <div className="flex justify-center items-center py-12">
                            <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#9b172a]"></div>
                        </div>
                    ) : (
                                        ...
                                        <div className="flex items-start justify-between mb-4">
                                            ...
                                            <div className="flex items-center gap-2">
                                                <button
                                                    ...
                                                    className="p-2 text-gray-400 hover:text-[#9b172a] transition-colors"
                                        ...
                                        <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
                                            <div className="flex items-center justify-between mb-2">
                                                ...
                                                <button
                                                    ...
                                                    className="text-sm text-[#9b172a] hover:text-[#9b172a]-700 dark:text-[#9b172a]-400 dark:hover:text-[#9b172a]-300"
                                                >
                                                    إضافة رقم
                                                </button>
                                            </div>
                                ...
                                <form onSubmit={handleCreateService} className="space-y-6">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-[#9b172a] focus:border-transparent dark:bg-gray-700 dark:text-white"
                                                required
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex justify-end gap-4 pt-6 border-t border-gray-200 dark:border-gray-700">
                                        ...
                                        <button
                                            ...
                                            className="px-6 py-2 bg-[#9b172a] text-white rounded-lg hover:bg-[#9b172a]-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center gap-2"
                                        >
                                            {createLoading ? (
                                                <>
                            ...
                            <div className="p-6">
                                ...
                                <form onSubmit={handleAddWhatsAppNumber} className="space-y-4">
                                    ...
                                    <div className="flex justify-end gap-4 pt-6 border-t border-gray-200 dark:border-gray-700">
                                        ...
                                        <button
                                            type="submit"
                                            className="px-6 py-2 bg-[#9b172a] text-white rounded-lg hover:bg-[#9b172a]-700 transition-colors flex items-center gap-2"
                                        >
                                            <FaPlus />
                                            Add Number
                                        </button>

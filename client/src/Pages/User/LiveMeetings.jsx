    ...
    <div key={meeting._id} className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-shadow duration-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        <div className="flex items-center text-gray-600 dark:text-gray-300">
          <FaCalendarAlt className="ml-2 text-[#9b172a]" />
        ...
        <div className="flex items-center text-gray-600 dark:text-gray-300">
          <FaChalkboardTeacher className="ml-2 text-[#9b172a]" />
          <span className="text-sm">{meeting.instructor?.name}</span>
        </div>
        <div className="flex items-center text-gray-600 dark:text-gray-300">
          <FaBookOpen className="ml-2 text-[#9b172a]" />
        ...
        <div className="flex items-center text-gray-600 dark:text-gray-300 col-span-full">
          ...
          <span className="text-sm">
            <a 
              ...
              className="text-[#9b172a] hover:text-[#9b172a]-800 underline break-all"
            >
        ...
        <div className="flex gap-2">
          ...
          {isMeetingUpcoming(meeting) && (
            <button
              ...
              className="flex items-center gap-1 px-4 py-2 bg-[#9b172a] hover:bg-[#9b172a]-700 text-white rounded-lg transition-colors duration-200 text-sm"
            >
              <FaPlay />
              تذكير
            </button>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center">
                      <FaCalendarAlt className="ml-3 text-[#9b172a]" />
                    ...
                    <div className="flex items-center">
                      <FaChalkboardTeacher className="ml-3 text-[#9b172a]" />
                    ...
                    <div className="flex items-center">
                      <FaBookOpen className="ml-3 text-[#9b172a]" />
              ...
              <div className="flex justify-end gap-4">
                ...
                {!isMeetingLive(selectedMeeting) && selectedMeeting.status === 'scheduled' && (
                  <button
                    ...
                    className="flex items-center gap-2 px-6 py-2 bg-[#9b172a] text-white rounded-lg hover:bg-[#9b172a]-700 transition-colors"
                  >
                    <FaVideo />
                    فتح الرابط
                    <FaExternalLinkAlt className="text-sm" />

  ...
  try {
    ...
    switch (dbType) {
      case 'atlas':
        ...
        break;
      case 'compass':
        uri = process.env.MONGO_URI_COMPASS || 'mongodb://localhost:27017/drahmedalitabase';
        break;
      case 'community':
  ...
  try {
    ...
    const sampleInstructors = [
      ...
      },
      {
        ...
        bio: "مدرس العلوم مع خبرة في تدريس الفيزياء والفيزياء",
        specialization: "العلوم",
        experience: 12,
        education: "ماجستير في الفيزياء",
        socialLinks: {
      ...
      },
      {
        ...
        bio: "مدرس التاريخ والجغرافيا مع نهج تعليمي قائم على القصص",
